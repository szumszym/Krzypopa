...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" name="street" placeholder="eg: Zakopianska" class="form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            <input type="text" name="postcode" class="form-control" data-mask="99-999">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" name="owner" value="z@gmail.pl" class="form-control">
