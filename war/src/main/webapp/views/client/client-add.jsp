...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" name="c_pesel" class="form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="text" name="c_nip" class="form-control">
    </div>
</div>
<!-- /.form-group -->
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            <input type="text" name="c_postcode" class="form-control" data-mask="99-999">
...
<script src="./assets/js/app/views/client/add.js"></script>
<script>
    $(".chzn-select").chosen();
</script>
<!--row End -->
