                            ...
                            <div id="div-1" class="accordion-body collapse in body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="first_name" class="control-label col-lg-4">Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="checkbox">
                                                <label>
                                                    <input id="published" class="uniform" type="checkbox"
                                    ...
                                    <div class="form-group">
                                        <label for="add-status-btn" class="control-label col-lg-4">Add Status</label>

                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <a href="#" id="add-status-btn" class="btn btn-primary"
                                                   data-original-title="" title="">Submit</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
