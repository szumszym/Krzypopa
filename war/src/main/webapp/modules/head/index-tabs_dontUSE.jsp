...
<head>
    ...
    <!-- Bootstrap -->
    <link href="./assets/lib/bootstrap/css/bootstrap-2.css" rel="stylesheet">
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#1" data-toggle="tab">Step One</a></li>
    <li><a href="#2" data-toggle="tab">Step Two</a></li>
    <li><a href="#3" data-toggle="tab">Step Three</a></li>
</ul>
<div class="tab-content">
<div class="tab-pane active" id="1">
    <div class="panel panel-default">
        <div class="panel-body">
            <strong>Select hotel</strong>
        </div>
            ...
            <div id="sortableTable" class="body collapse in">
                <table id="client-table-small"
                    ...
                    <tr>
                        <td>1</td>
                        <td>Luka</td>
                        <td>Malibu Klasik 3 599-23 Maliby</td>
                        <td>Three star hotel in malibu</td>
                        <td><a herf="#" class=" text-center">link</a></td>
                    </tr>
                    <tbody>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <div class="input-group col-lg-12">
                    <label class="control-label col-lg-4">How many people :</label>
                ...
                <div class="input-group col-lg-12">
                    <label class="control-label col-lg-4">Reservation begin :</label>
                ...
                <div class="input-group col-lg-12">
                    <label class="control-label col-lg-4">Reservation ends :</label>
                ...
                <div class="input-group col-lg-12 ">
                    <div class="margines">
                        <a class="btn btn-lg btn-success" href="#" role="button">Continue</a>
                    </div>
                </div>
            ...
            <div id="sortableTable-12" class="body collapse in">
                <table id="client-table-small"
                    ...
                    <tr>
                        ...
                        <td>Luka</td>
                        <td>3</td>
                        <td>room have 2 beds one for 2 person secand for 1</td>
                        <td><a herf="#" class=" text-center">link</a></td>
                    </tr>
                    <tbody>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <div class="input-group col-lg-12">
                    ...
                    <label class="col-lg-8 label-right">
                        Klasik Monteral
                    </label>
                </div>

                <div class="input-group col-lg-12">
                    <label class="col-lg-4">Reservation begin :</label>
                    <label class="col-lg-8 label-right">
                        20-10-2015
                    </label>
                </div>
                ...
                <div class="input-group col-lg-12">
                    <label class="col-lg-4">Reservation ends :</label>
                    <label class="col-lg-8 label-right">
                        01-11-2015
                    </label>
                </div>
                <div class="input-group col-lg-12">
                    <label class="col-lg-4">People :</label>
                    <label class="col-lg-8 label-right">
                        3
                    </label>
                </div>
                ...
                <div class="input-group col-lg-12">
                    <label class="col-lg-4">Cost:</label>
                    <label class="col-lg-8 label-right">
                        12123€
                    </label>
                </div>
